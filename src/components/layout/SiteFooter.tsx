...
export default function SiteFooter() {
  return (
    <footer className="relative z-10 w-full shrink-0 overflow-hidden bg-[linear-gradient(to_bottom,var(--background)_0%,var(--background)_30%,var(--background-dark)_100%)] px-6 pb-10 pt-14 text-sm sm:px-12">
